export const dailyRewardsV2Abi = [
  ...
  { inputs: [], name: "GlobalDailyClaimLimitExceeded", type: "error" },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "bool", name: "globalLimitReached", type: "bool" },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_dailyClaimLimit", type: "uint256" },
    ],
